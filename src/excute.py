...
def main():
    ...
    print(summary)
    summary.to_csv('/home/ubuntu/crawl/crawler-recommend-sys/data/benchmark/summary_with_improve_build_outsource_profile.csv', index=False)
    print('---------- Per User Results ----------')
    print(per_user)
    per_user.to_csv('/home/ubuntu/crawl/crawler-recommend-sys/data/benchmark/per_user_with_improve_build_outsource_profile.csv', index=False)
main()